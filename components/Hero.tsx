    ...
    <section id="home" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <div className="container-max text-center px-4">
        ...
        >
          ...
          >
            Hi, I'm{' '}
            <span className="gradient-text">Abreham Bekele</span>
          </motion.h1>
          ...
          >
            I build applications that are not only functional but also scalable, maintainable, 
            and deliver an exceptional user experience. Let's create something amazing together.
          </motion.p>
